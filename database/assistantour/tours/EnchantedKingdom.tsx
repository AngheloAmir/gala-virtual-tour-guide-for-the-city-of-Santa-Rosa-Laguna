...
const EnchantedKindom :GalaSelfGuidedTour = {
    ...
    pointOfInterests: [
        ...
        { lat: 14.282474, lng: 121.095424, name: 'Brooklyn',
            description: 'This place resembles the Brooklyn in New York city, USA. There is only one attraction here, the Rialto 4D - a fun thrilled watching a movie.',
        },
        ...
        { lat: 14.282642, lng: 121.093968, name: 'Jungle Log ',
            description: 'Jungle Log is one of the extreme rides. Caution has to be taken when riding this ride as you may get wet, and the fall speed may put a lot of pressure on your heart.',
        },
